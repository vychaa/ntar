...
export default function Home() {
  return (
    <div style={{ overflowX: "hidden" }}>
      ...
      <div className="contentboxwhite-2">
      ...
      <div className="contentboxblack-7">
        <div className="ntar-begins2">
          <div className=" magicmoney-div">
            <p className="magic-money">Money </p>
            <img className="gif2" src={orgntar} alt="Girl" />
            <p className="magic">
              Magic.
              <br />
            </p>
